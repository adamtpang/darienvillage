  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "btn-premium relative overflow-hidden font-semibold tracking-wide hover:scale-105 active:scale-95",
        quality: "bg-gradient-to-r from-gold-primary to-gold-secondary text-white shadow-elegant hover:shadow-elegant hover:scale-105 border-0 font-semibold",
        glass: "glass-card-quality text-foreground hover:scale-105 border border-white/20",
        success: "bg-gradient-to-r from-emerald-primary to-emerald-secondary text-white shadow-elegant hover:shadow-success hover:scale-105",
      },
      size: {
        default: "h-11 px-6 py-3",
        sm: "h-9 rounded-md px-4 text-xs",
        lg: "h-14 rounded-xl px-10 text-lg font-semibold",
        xl: "h-16 rounded-xl px-12 text-xl font-semibold",
        icon: "h-11 w-11",
      },
    },
    defaultVariants: {
